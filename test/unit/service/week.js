  ...
  describe('week', function () {
    ...
    describe('#getProjects', function () {
      it('gets planned and reported hours', function () {
        $httpBackend.expectGET('http://api-secure.iteam.se/week/197001/197001').respond(200)
        $httpBackend.expectGET('http://api-secure.iteam.se/week/-1/197001/reported').respond(200)
        $httpBackend.expectGET('http://api-secure.iteam.se/week/-1/197001/calendar').respond(200)
